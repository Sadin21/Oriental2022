...
<section>
    ...
    <div class="container my-5">
      <div class="row my-5" style="font-family: Poppins, sans-serif">
        <div class="col-md-3 pt-3">
          <h1
            class="fw-semibold pb-xl-0 mb-xl-0 fs-4"
            style="
          ...
          <h1
            class="fw-semibold mt-xl-0 pt-xl-0 fs-4"
            style="
              color: rgba(33, 37, 41, 0.87);
              font-family: Poppins, sans-serif;
            "
  ...
  <section class="my-5">
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdOsF0hNi2hZVTlBoHFRWlOyAdhSx9bffWyS6SoTzXGtUYJWg/viewform?embedded=true" width="1200" height="600" frameborder="0" marginheight="0" marginwidth="0">Memuat…</iframe>
  </section>
